#tag DesktopWindow
Begin DesktopWindow wndDataQueryItem_pivot
   Backdrop        =   0
		  ...
		  for i as integer = 0 to 6
		    ...
		    if BlockName(i).visible then
		      ...
		      if curStep.prevDataQueryItem<>nil then 
		        ...
		        kt=curStep.prevDataQueryItem.getKeyType(ppField1.SelectedRowText)
		        eff=efConstant1(i)
		        bErr=bErr or not validOneValue(eff,kt)
		        
		        kt=curStep.prevDataQueryItem.getKeyType(ppField2.SelectedRowText)
		        eff=efConstant2(i)
		        bErr=bErr or not validOneValue(eff,kt)
		        
		        kt=curStep.prevDataQueryItem.getKeyType(ppField3.SelectedRowText)
		        eff=efConstant3(i)
		        bErr=bErr or not validOneValue(eff,kt)
	...
	#tag Event
		Sub MouseEnter(index as Integer)
		  ...
		  if me.BackColor=rgb(255,0,0) then
		    ...
		    kt=curStep.prevDataQueryItem.getKeyType(sb)
