#tag DesktopWindow
Begin DesktopWindow wnd_rank_help
   Backdrop        =   0
   ...
   Begin DesktopBevelButton BevelButton2
      ...
      _mPanelIndex    =   0
   End
   Begin DesktopImageViewer ImageWell7
      Active          =   False
      AllowAutoDeactivate=   True
      AllowTabStop    =   True
      Enabled         =   False
   ...
   Begin Label stpg
      ...
      Width           =   29
   End
   Begin DesktopTabPanel PagePanel1
      AllowAutoDeactivate=   True
      Bold            =   False
      Enabled         =   True
      FontName        =   "System"
      ...
      Scope           =   0
      SmallTabs       =   False
      TabDefinition   =   "Introduction\rStart\rGroup/Split\rFilter\rCalc\rMap\rPivot\rSort"
      TabIndex        =   4
      TabPanelIndex   =   0
      TabStop         =   True
      Tooltip         =   ""
      ...
      Begin Label StaticText7
         ...
         TabPanelIndex   =   2
         TabStop         =   True
         Text            =   "This is the place where the process starts. There are no parameters to define or change in this type of step.\r\n\r\nIt can be seen as the source of all data."
         TextAlignment   =   0
         TextColor       =   &c00000000
         Tooltip         =   ""
         Top             =   55
      ...
      Begin Label StaticText12
         ...
         TabPanelIndex   =   6
         TabStop         =   True
         Text            =   "The database  uses a field name to identify each field. In some cases, those field names are not easy to use. The map step can be used to alter the name of those fields.\r\n\r\nFor instance, a field labelled 'Adjusted_Total_Gross_Sales_Company' might be renamed 'Gross_Sales'.\r\n\r\nThe tool always uses all number fields (like sales, turnover, ..) in the calculatation steps. By leaving the output field name empty, the corresponding field will be removed from the analysis.\r\n"
         TextAlignment   =   0
         TextColor       =   &c00000000
         Tooltip         =   ""
         Top             =   55
      ...
      Begin Label StaticText13
         ...
         TabPanelIndex   =   1
         TabStop         =   True
         Text            =   "Reporting / data extraction"
         TextAlignment   =   0
         TextColor       =   &c00000000
         Tooltip         =   ""
         Top             =   33
      ...
      Begin Label StaticText18
         ...
         TabPanelIndex   =   9
         TabStop         =   True
         Text            =   "The database uses a field name to identify each field. In some cases, those field names are not easy to use.\r\n\r\nThe mapping step can be used to alter the name of fields.\r\nFor instance a field labelled 'Adjusted_Total_Gross_Sales_Company' might be renamed to 'Gross_Sales'.\r\n\r\nThe tool always shows and uses all available fields. For instance, all value fields are always involved in each calculation steps.\r\n\r\nThe Map function may be used to hide some fields."
         TextAlignment   =   0
         TextColor       =   &c00000000
         Tooltip         =   ""
         Top             =   40
      ...
      Begin Label StaticText20
         ...
         TabPanelIndex   =   8
         TabStop         =   True
         Text            =   "The database stores the data in rows. The order of the rows is undefined. If your process contains a 'group/split' step, then the records will be sorted according to the value stored in the fields used to group/split the records.\r\n\r\nIf you want to get the data in another order, you can use the sort step to define the order or records.\r\n\r\nThis step is usually the last step in a process."
         TextAlignment   =   0
         TextColor       =   &c00000000
         Tooltip         =   ""
         Top             =   58
      ...
      Begin DesktopTabPanel tabPanel2
         ...
         Scope           =   0
         SmallTabs       =   False
         TabDefinition   =   "Pivot (intersection mode)\rPivot (using a master key)"
         TabIndex        =   18
         TabPanelIndex   =   7
         TabStop         =   True
         Tooltip         =   ""
         ...
         Begin Label StaticText2
            ...
            TabPanelIndex   =   7
            TabStop         =   True
            Text            =   "A data item (combination of key values) is included in the output if it exists in all 'blocks'. \r\nFor example, if the segment is a key field and the Pivot is built as described above, a segment is included in the output is there are sales to that segment in 2004 and 2005."
            TextAlignment   =   0
            TextColor       =   &c00000000
            Tooltip         =   ""
            Top             =   326
         ...
         Begin Label StaticText22
            ...
            TabPanelIndex   =   2
            TabStop         =   True
            Text            =   "A data item (combination of key values) is included in the output if it exists in the 'blocks' defined as 'master key'. Data for other blocks are included if they exist, otherwise they are replaced by zero.\r\nFor example, if the segment is a key field and the Pivot is built as described above with Y2005 as master key, a segment is included in the output is there are sales to that segment in 2005. The sales for 2004 are included if they exist, otherwise the reported value is zero. Any segments with sales in 2004 but not sales in 2005 are ignored."
            TextAlignment   =   0
            TextColor       =   &c00000000
            Tooltip         =   ""
            Top             =   311
...
#tag WindowCode
	#tag Event
		Sub Opening()
		  ...
		  stpg.caption=str(PagePanel1.SelectedPanelIndex+1)+"/"+str(PagePanel1.PanelCount)
...
#tag Events BevelButton1
	#tag Event
		Sub Pressed()
		  dim p as integer
		  p=PagePanel1.SelectedPanelIndex
		  if p>0 then 
		    PagePanel1.SelectedPanelIndex=p-1
		  else
		    PagePanel1.SelectedPanelIndex=PagePanel1.PanelCount -1
		  end if
...
#tag Events BevelButton2
	#tag Event
		Sub Pressed()
		  dim p as integer
		  p=PagePanel1.SelectedPanelIndex
		  if p<PagePanel1.PanelCount  then 
		    PagePanel1.SelectedPanelIndex=p+1
		  else
		    PagePanel1.SelectedPanelIndex=0
		  end if
